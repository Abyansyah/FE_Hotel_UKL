      ...
      <div className="flex flex-col gap-y-5">
        ...
        <div className="flex justify-between">
          {isLoading ? (
            ...
            tipe?.map((item, index) => (
              <Link href={`/hotel/${item.id}`} className="flex flex-col bg-[#FAFAFA] w-[380px] rounded-xl overflow-hidden" key={index}>
                <Image className="w-[380px] h-[280px] bg-contain" src={'http://localhost:8000/foto_tipe_kamar/' + item.foto} width={380} height={280} alt="image" />
                ...
                <div className="flex gap-8 items-center px-4 pb-4">
                  <p className="text-[#222] font-normal">Rp. {item.harga} Par Night</p>
